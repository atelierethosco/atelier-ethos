...
**Neden:** Ece teknik araç (CLI, VS Code, GitHub Desktop) kullanmıyor. GitHub'da şu URL ile direkt yeni dosya oluşturuluyor:
https://github.com/atelierethosco/atelier-ethos/new/astro-migration
Claude her dosyayı tam yol + tam içerik şeklinde verecek.
...
- Tur 1: Astro iskelet + global.css + BaseLayout + Navbar + Footer + StickyCTA + geçici index ✅
...
- Genel mail: info@atelierethos.com (henüz açılmadıysa açılacak)
- Adres: Kızılırmak Mah. Dumlupınar Blv. No:3 C-1 İç Kapı No:160, Çankaya/Ankara
- Telefon: +90 530 474 69 48
- Sosyal: LinkedIn (/company/atelier-ethos), Instagram (@atelierethos), WhatsApp kanalı
...
- [ ] Genel mail (info@atelierethos.com) açıldı mı?
...
- [ ] bireysel.html — Ece tarafından ayrı bir amaç için yüklendi, Astro yapısına dahil edilmiyor
